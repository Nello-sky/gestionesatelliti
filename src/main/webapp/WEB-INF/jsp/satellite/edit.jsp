									...
									<form:form modelAttribute="edit_satellite_attr" method="post" action="${pageContext.request.contextPath}/satellite/update" class="row g-3" novalidate="novalidate">
										...
										<div class="col-md-6">
											...
											<spring:bind path="denominazione">
												<input type="text" name="denominazione" id="denominazione" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il nome" value="${edit_satellite_attr.denominazione }" required>
											</spring:bind>
										...
										<div class="col-md-6">
											...
											<spring:bind path="codice">
												<input type="text" name="codice" id="codice" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il cognome" value="${edit_satellite_attr.codice }" required>
											</spring:bind>
										...
										<fmt:formatDate pattern="yyyy-MM-dd" value="${localDateToBeParsed}" var="parsedDate"/>
										<div class="col-md-3">
											<label for="dataRientro" class="form-label">Data di lancio <span class="text-danger">*</span></label>
